    ...
    return (
        <View style = {{ ...props.style, shadowColor: 'black', shadowOffset: { width: 2, height: 4 }, shadowRadius: 5, shadowOpacity: 0.3, marginBottom: 20 }}>
            ...
            <View style = {{ backgroundColor: 'white', padding: 15 }}>
                <Text style = {{ fontFamily: 'OpenSans_600SemiBold', color: 'black', fontSize: 16, marginBottom: 6 }}>{props.title} {props.registered ? <Ionicons name="checkmark-outline" size = {20} color = "orange" /> : null}</Text>
